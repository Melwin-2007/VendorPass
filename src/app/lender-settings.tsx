  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.profileInfo}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              <Text style={styles.profileName}>{user?.name || 'Lender Name'}</Text>
              <View style={styles.verifiedBadge}>
                <Text style={styles.verifiedText}>Verified Lender</Text>
              </View>
            </View>
        ...
        {/* LENDING PREFERENCES */}
        <Text style={styles.sectionTitle}>LENDING PREFERENCES</Text>
        <View style={styles.cardGroup}>
          <SettingRow 
            icon="📍" 
            label="Lending Radius" 
            onPress={() => {}} 
            rightElement={<Text style={styles.inlineValue}>5 km</Text>}
          />
          <SettingRow 
            icon="🎯" 
            label="Preferred Risk Tier" 
            onPress={() => {}} 
            rightElement={<Text style={styles.inlineValue}>Gold & Above</Text>}
          />
          <SettingRow 
            icon="💰" 
            label="Auto-Approve Limit" 
            onPress={() => {}} 
            rightElement={<Text style={styles.inlineValue}>₹25,000</Text>}
          />
          <SettingRow 
            icon="🔔" 
